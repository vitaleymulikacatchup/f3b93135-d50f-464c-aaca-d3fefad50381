...
export const metadata: Metadata = {
  title: "AUTOZAZ Factory - Premium Vehicle Manufacturing",
  description: "Leading automotive manufacturer producing quality vehicles with advanced technology and precision engineering. 50,000+ vehicles manufactured with 99.8% quality rate.",
  keywords: "factory, manufacturing, vehicles, automotive, production, quality, precision",
  metadataBase: new URL("https://autozaz.com"),
  alternates: {
    canonical: "https://autozaz.com"
  },
  openGraph: {
    title: "AUTOZAZ Factory - Vehicle Manufacturing Excellence",
    description: "Premium automotive manufacturing with state-of-the-art technology and quality assurance",
    siteName: "AUTOZAZ",
    url: "https://autozaz.com",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=hero-vehicle-1",
        alt: "AUTOZAZ manufactured vehicles"
      }
    ]
  },
  twitter: {
    ...
    title: "AUTOZAZ Factory - Premium Vehicle Manufacturing",
    description: "Leading automotive manufacturer with 50K+ vehicles produced",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/default/no-image.jpg?id=hero-vehicle-1"]
  },
  robots: {
    index: true,
    follow: true
